...
fn build_headers(provider: &PostProcessProvider, api_key: &str) -> Result<HeaderMap, String> {
    ...
    headers.insert(
        REFERER,
        HeaderValue::from_static("https://github.com/BinhL3/notch-scribe"),
    );
    headers.insert(
        USER_AGENT,
        HeaderValue::from_static("Noi/1.0 (+https://github.com/BinhL3/notch-scribe)"),
    );
    headers.insert("X-Title", HeaderValue::from_static("Noi"));
